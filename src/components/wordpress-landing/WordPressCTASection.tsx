...
interface WordPressCTASectionProps {
  translations: any;
}

const WordPressCTASection: React.FC<WordPressCTASectionProps> = ({ translations }) => {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          <span className="font-sans">
            {getTranslation(translations, 'wordpressLanding.cta.button')}
          </span>
